...
- (NSArray *)viewControllersForTabBar {
    ImgScrollViewController *homeVC = [[ImgScrollViewController alloc] init];
       ...
       // 同城
       AnimationViewController *myCityVC = [[AnimationViewController alloc] init];
       ...
       // 消息
       FileListViewController *messageVC = [[FileListViewController alloc] init];
       ...
       // 我的
       AddressListViewController *accountVC = [[AddressListViewController alloc] init];
...
//         standardAppearance.shadowImage = [[self class] imageWithColor:[UIColor cyl_systemGrayColor] size:CGSizeMake([UIScreen mainScreen].bounds.size.width, 10)];
                 standardAppearance.shadowImage = [[self class] imageWithColor:[UIColor colorWithHexString:@"e9e9e9"] size:CGSizeMake([UIScreen mainScreen].bounds.size.width, 15)];
        ...
        [[UITabBar appearance] setShadowImage:[[self class] imageWithColor:[UIColor colorWithHexString:@"e9e9e9"] size:CGSizeMake([UIScreen mainScreen].bounds.size.width, 1)]];
    }
}
//
...
- (void)tabBarController:(UITabBarController *)tabBarController didSelectControl:(UIControl *)control {
    NSLog(@"%ld",(long)control.cyl_tabBarItemVisibleIndex);
    if (control.cyl_tabBarItemVisibleIndex == 2) {
