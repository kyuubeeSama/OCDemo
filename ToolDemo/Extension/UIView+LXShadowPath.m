...
-(void)LX_SetShadowPathWith:(UIColor *)shadowColor shadowOpacity:(CGFloat)shadowOpacity shadowRadius:(CGFloat)shadowRadius shadowSide:(LXShadowPathSide)shadowPathSide shadowPathWidth:(CGFloat)shadowPathWidth{
    ...
    switch (shadowPathSide) {
        ...
        case LXShadowPathAllSide:
            ...
            break;
        case LXShadowPathLeftRight:
            shadowRect = CGRectMake(originX - shadowPathWidth/2, originY, originW +shadowPathWidth, originH);
            break;
        case LXShadowPathNoBottom:
            shadowRect = CGRectMake(originX -shadowPathWidth/2, originY - shadowPathWidth/2, originW +shadowPathWidth, originH + shadowPathWidth/2);
            break;
          }
