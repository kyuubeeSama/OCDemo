...
//  ToolDemo
//
//  Created by liuqingyuan on 2020/5/15.
...
//    UIImage *normalButtonImage = [UIImage imageNamed:@"tabbar_add_yellow"];
        UIImage *normalButtonImage = [UIImage imageWithBorder:5 color:[UIColor whiteColor] image:[UIImage imageNamed:@"tab_index"]];
    UIImage *hlightButtonImage = [UIImage imageNamed:@"tabbar_add_yellow"];
    ...
    // 设置背景图片
//    UIImage *normalButtonBackImage = [UIImage imageNamed:@"tabbar_add_yellow"];
